...
--[[
    ...
    * Try to use standard Lua libraries as much as possible like luaposix, optparse,
      etc.
    * The script will be run on FreeBSD 13.1-RELEASE (for now)
    ...
    * How to handle the build and test results? (simple matrix print or some other
      ...
      -- logs run store them
    * data-sourcing 
        mkimg : make it smart while building it makes sense according to architectures
...
if args.configfile == "input.lua" then
    args.configfile = "conf/"..args.configfile
